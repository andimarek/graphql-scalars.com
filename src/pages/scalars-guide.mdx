...
There are no restrictions beside syntax. For example an AST element can be `1234568901234567890` which 
...
These values are then used to pass into the GraphQL engine to execute the request.
...
but details may vary. Especially the naming of the coercion function is not consistent
across eco systems.
